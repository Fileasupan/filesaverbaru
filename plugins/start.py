        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("𝗔𝘀𝘂𝗽𝗮𝗻 𝟭𝟴+", callback_data = "about"),
...
async def not_joined(client: Client, message: Message):
    text = "<b>𝗔𝗻𝗱𝗮 𝗵𝗮𝗿𝘂𝘀 𝗷𝗼𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗲𝗹/𝗚𝗿𝗼𝘂𝗽 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗻𝗴𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗕𝗢𝗧.\n 𝙆𝙖𝙡𝙖𝙪 𝙗𝙚𝙡𝙪𝙢 𝙟𝙤𝙞𝙣, 𝘽𝙊𝙏 𝙩𝙞𝙙𝙖𝙠 𝙢𝙚𝙣𝙜𝙞𝙧𝙞𝙢 𝙛𝙞𝙡𝙚/𝙩𝙞𝙙𝙖𝙠 𝘽𝙚𝙠𝙚𝙧𝙟𝙖. 𝙠𝙖𝙡𝙖𝙪 𝙨𝙪𝙙𝙖𝙝 𝙟𝙤𝙞𝙣 𝙨𝙞𝙡𝙖𝙝𝙠𝙖𝙣 𝙠𝙡𝙞𝙠</b>"
    message_text = message.text
    try:
        command, argument = message_text.split()
        text = text + f" <b>Dan Klik <a href='https://t.me/{client.username}?start={argument}'>𝐆𝐄𝐓 𝐅𝐈𝐋𝐄</a>\n\nLalu Buka Lagi Link Sebelumnya Atau klik <a href='https://t.me/{client.username}?start={argument}'>𝐆𝐄𝐓 𝐅𝐈𝐋𝐄</a></b>"
    except ValueError:
        pass
    reply_markup = InlineKeyboardMarkup(
        [
